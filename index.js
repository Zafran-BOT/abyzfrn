...
/////////////////
const BotName = 'Z F R N B O T☄'; 
const instagram = 'https://instagram.com/abyzfrn17_'; 
const telegram = 'https://t.me/abyzfrn17_'; 
const kapanbotaktif = 'KETIKA SERVER TIDAK LAG'; 
const youtube = 'https://www.youtube.com/c/zafr6n';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@abyzfrn17_')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@abyzfrn17_`)
})
